    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Column(
            children: [
              BackArrow(title: 'Change password',),
          SafeArea(
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    onChanged: () {
                      setState(() {
                        _newPasswordError = null;  // Clear error on input change
                      });
                    },
                  ),
                  CustomTextField(
                    ...
                    onChanged: () {
                      setState(() {
                        _confirmPasswordError = null;  // Clear error on input change
                      });
                    },
                  ),
              ...
              child: const Text(
                ...
                style: TextStyle(
                  ...
                  ElevatedButton(
                      ...
                      if (_passwordError == null && _newPasswordError == null && _confirmPasswordError == null) {
